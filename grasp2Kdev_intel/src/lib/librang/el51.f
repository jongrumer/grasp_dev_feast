...
C
      IF (ICOLBREI .EQ. 1) THEN
        ...
        GO TO 23
   22   CALL COULOM(L3,L4,L1,L2,ID3(5),ID4(5),ID1(5),ID2(5),KRA,A1)
...
C
      ...
      IF(IXJTIK(J(1),J(3),KRA*2,J(4),J(2),J12*2).EQ.0)GO TO 3
      AA=AA*RAG
      IF(ABS(AA).LT.EPS) GO TO 3
...
C
      IF (ICOLBREI .EQ. 1) THEN
        ...
        GO TO 24
   25   CALL COULOM(L3,L4,L2,L1,ID3(5),ID4(5),ID2(5),ID1(5),KRA,A1)
...
C
      ...
      AA=AA*RAG
      IF(ABS(AA).LT.EPS) GO TO 13
      IF(IXJTIK(J(1),J(4),KRA*2,J(3),J(2),J12*2).EQ.0)GO TO 13
