...
*     ...General description
      ...
      WRITE(*,*)
C      WRITE (istde,*) 'extmix - Extract mixing coefficients and CSF'
C      WRITE (istde,*)  'Files to be read :'
C      WRITE (istde,*)  '    <name>.c,  <name>.m / <name>.cm'
C      WRITE (istde,*)  'Files to be written :'
C      WRITE (istde,*)  '    rcsl.out, screen output'
