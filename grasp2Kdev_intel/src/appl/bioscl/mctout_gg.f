...
*
      POINTER (PLABEL,LABEL(*)),(PCOEFF,COEFF(*))
*
      POINTER (PISLDR,ISLDR(*)),(PXSLDR,XSLDR(*))
      POINTER (PISLDR1,ISLDR1(*))
      POINTER (PNTLAB,LAB(*)),(PNNPTR,NPTR(*))
      POINTER (PNTRKP,KP(*))
*
...
* NCFF(I): the end position of the Ith block for the final states in the globle CSF list
      common /IBLK/NBLOCKI,NCFI(30)
      common /FBLK/NBLOCKF,NCFF(30)
*
...
CGG           CALL TNSRJJ (LK,IOPAR,IC,IR,IAIA,IBIB,TSHELL)
           IF (IA .NE. 0) THEN
              IF (IA .EQ. IB) THEN
                 DO 2 IA = 1,NW
