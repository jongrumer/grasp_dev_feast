...
*   the radial and angular modules of the GRASP2K suite.               *
*                                                                      *
...
*
         ...
         STATUS = 'NEW'
*
         PRINT *, 'File  ris.dbg  will be created as the'
         PRINT *, ' RIS3 DeBuG Printout File; enter another'
...
*
    4    CALL OPENFL (99,FILNAM,FORM,STATUS,IERR)
         IF (IERR .NE. 0) THEN
    5       PRINT *, 'Enter a name for the RIS3 DeBuG Printout'
...
*
         ...
         IF (YES) THEN
            ...
            YES = GETYN ()
            IF (YES) LDBPA(1) = .TRUE.
            PRINT *, ' Print out V coefficients?'
            YES = GETYN ()
            IF (YES) LDBPA(2) = .TRUE.
         ENDIF
*
