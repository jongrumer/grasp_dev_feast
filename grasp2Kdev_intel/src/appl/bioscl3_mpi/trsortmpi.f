...
Cww      INTEGER PNTRIQ
      ...
      CHARACTER*24 NAME(2)
*
      POINTER (PIBEG,IBEG(*)),(PILAB,ILAB(*)),(PILAST,ILAST(*)),
     :        (PILEFT,ILEFT(*)),(PIPTCS,IPTCSF(*)),(PIRIGH,IRIGHT(*)),
     :        (PLBLIN,LBLINT(*))
      POINTER (PIPTR,IPTR(*)),(PISLDR,ISLDR(*)),(PXSLDR,XSLDR(*))
      POINTER (PISLDR1,ISLDR1(*))
*
      POINTER (PLABEL,JLABL(*)),(PCOEFF,XL(*))
      POINTER (PNTRKP,KP(*))
*
