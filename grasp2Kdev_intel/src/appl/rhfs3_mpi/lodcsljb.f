...
c      print *, ' NNNWP*3*NCFD = ' , NNNWP*3*NCFD
...
*
         IF (NCF .GT. NCFD) THEN
            NEWSIZ = NCFD+NCFD/2
cbdebug
c     print *, ' NCF, NCFD, NEWSIZ = ', NCF, NCFD, NEWSIZ
c     print *, ' NNNWP*3*NEWSIZ*4 = ', NNNWP*3*NEWSIZ*4 
c     print *, ' lodcsljb.f 5 '
            CALL RALC2D (PNTRIQ,NNNWP  ,NCFD,NNNWP  ,NEWSIZ,4)
c     print *, ' lodcsljb.f 6 '
            CALL RALC2D (PNTJQS,NNNWP*3,NCFD,NNNWP*3,NEWSIZ,4)
c     print *, ' lodcsljb.f 7 '
            CALL RALC2D (PNJCUP,NNNWP  ,NCFD,NNNWP  ,NEWSIZ,4)
c     print *, ' lodcsljb.f 8 '
            NCFD = NEWSIZ
         ENDIF
*
