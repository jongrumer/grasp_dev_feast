*     last edited Januar 2, 1997
      subroutine  Blandb(org,nmax,varmax,lock,fil,low,lim, 
     :                   posn,posl,minJ,maxJ)
      integer fil_1,fil_2
      ...
      integer varmax,par0,par,i,j,antal,posn(110),posl(110)
      integer lim(15),dum,fil,minJ,maxJ
...
*     2p
     ...
     :                      low,start(2,1),stopp(2,1))
      do 210 an21 = start(2,1),stopp(2,1),-1
...
*     3s
     ...
     :                      low,start(3,0),stopp(3,0))
      do 300 an30 = start(3,0),stopp(3,0),-1
         antel(3,0) = an30 + antel(2,1)
         if (antel(3,0).LE.antal) then 
            ansats(3,0,0) = an30
*     3p
      call Sluggo(3,1,varmax,varupp,varned,ansats,org,lock(3,1),
     :                      low,start(3,1),stopp(3,1))
      do 310 an31 = start(3,1),stopp(3,1),-1
...
*     3d
     ...
     :                      low,start(3,2),stopp(3,2))
      do 320 an32 = start(3,2),stopp(3,2),-1
...
*     4s
     ...
     :                      low,start(4,0),stopp(4,0))
      do 400 an40 = start(4,0),stopp(4,0),-1
         antel(4,0) = an40 + antel(3,2)
         if (antel(4,0).LE.antal) then 
            ansats(4,0,0) = an40
*     4p
      call Sluggo(4,1,varmax,varupp,varned,ansats,org,lock(4,1),
     :                      low,start(4,1),stopp(4,1))
      do 410 an41 = start(4,1),stopp(4,1),-1
...
*     4d
     ...
     :                      low,start(4,2),stopp(4,2))
      do 420 an42 = start(4,2),stopp(4,2),-1
...
*     4f
     ...
     :                      low,start(4,3),stopp(4,3))
      do 430 an43 = start(4,3),stopp(4,3),-1
...
*     5s
     ...
     :                      low,start(5,0),stopp(5,0))
      do 500 an50 = start(5,0),stopp(5,0),-1
         antel(5,0) = an50 + antel(4,3)
         if (antel(5,0).LE.antal) then 
            ansats(5,0,0) = an50
*     5p
      call Sluggo(5,1,varmax,varupp,varned,ansats,org,lock(5,1),
     :                      low,start(5,1),stopp(5,1))
      do 510 an51 = start(5,1),stopp(5,1),-1
...
*     5d
     ...
     :                      low,start(5,2),stopp(5,2))
      do 520 an52 = start(5,2),stopp(5,2),-1
...
*     5f
     ...
     :                      low,start(5,3),stopp(5,3))
      do 530 an53 = start(5,3),stopp(5,3),-1
...
*     5g
     ...
     :                      low,start(5,4),stopp(5,4))
      do 540 an54 = start(5,4),stopp(5,4),-1
...
*     6s
     ...
     :                      low,start(6,0),stopp(6,0))
      do 600 an60 = start(6,0),stopp(6,0),-1
...
*     6p
     ...
     :                      low,start(6,1),stopp(6,1))
      do 610 an61 = start(6,1),stopp(6,1),-1
...
*     6d
     ...
     :                      low,start(6,2),stopp(6,2))
      do 620 an62 = start(6,2),stopp(6,2),-1
...
*     6f
     ...
     :                      low,start(6,3),stopp(6,3))
      do 630 an63 = start(6,3),stopp(6,3),-1
...
*     6g
     ...
     :                      low,start(6,4),stopp(6,4))
      do 640 an64 = start(6,4),stopp(6,4),-1
...
*     6h
     ...
     :                      low,start(6,5),stopp(6,5))
      do 650 an65 = start(6,5),stopp(6,5),-1
...
*     7s
     ...
     :                      low,start(7,0),stopp(7,0))
      do 700 an70 = start(7,0),stopp(7,0),-1
...
*     7p
     ...
     :                      low,start(7,1),stopp(7,1))
      do 710 an71 = start(7,1),stopp(7,1),-1   
...
*     7d
     ...
     :                      low,start(7,2),stopp(7,2))
      do 720 an72 = start(7,2),stopp(7,2),-1
...
*     7f
     ...
     :                      low,start(7,3),stopp(7,3))
      do 730 an73 = start(7,3),stopp(7,3),-1
...
*     7g
     ...
     :                      low,start(7,4),stopp(7,4))
      do 740 an74 = start(7,4),stopp(7,4),-1
...
*     7h
     ...
     :                      low,start(7,5),stopp(7,5))
      do 750 an75 = start(7,5),stopp(7,5),-1
...
*     7i
     ...
     :                      low,start(7,6),stopp(7,6))
      do 760 an76 = start(7,6),stopp(7,6),-1
...
*     8s
     ...
     :                      low,start(8,0),stopp(8,0))
      do 800 an80 = start(8,0),stopp(8,0),-1
...
*     8p
     ...
     :                      low,start(8,1),stopp(8,1))
      do 810 an81 = start(8,1),stopp(8,1),-1
...
*     8d
     ...
     :                      low,start(8,2),stopp(8,2))
      do 820 an82 = start(8,2),stopp(8,2),-1
...
*     8f
     ...
     :                      low,start(8,3),stopp(8,3))
      do 830 an83 = start(8,3),stopp(8,3),-1
...
*     8g
     ...
     :                      low,start(8,4),stopp(8,4))

      do 840 an84 = start(8,4),stopp(8,4),-1
...
*     8h
     ...
     :                      low,start(8,5),stopp(8,5))
      do 850 an85 = start(8,5),stopp(8,5),-1
...
*     8i
     ...
     :                      low,start(8,6),stopp(8,6))
      do 860 an86 = start(8,6),stopp(8,6),-1
...
*     8k
     ...
     :                      low,start(8,7),stopp(8,7))
      do 870 an87 = start(8,7),stopp(8,7),-1
...
*     9s
     ...
     :                      low,start(9,0),stopp(9,0))
      do 900 an90 = start(9,0),stopp(9,0),-1
...
*     9p
     ...
     :                      low,start(9,1),stopp(9,1))
      do 910 an91 = start(9,1),stopp(9,1),-1
...
*     9d
     ...
     :                      low,start(9,2),stopp(9,2))
      do 920 an92 = start(9,2),stopp(9,2),-1
...
*     9f
     ...
     :                      low,start(9,3),stopp(9,3))
      do 930 an93 = start(9,3),stopp(9,3),-1
...
*     9g
     ...
     :                      low,start(9,4),stopp(9,4))
      do 940 an94 = start(9,4),stopp(9,4),-1
...
*     9h
     ...
     :                      low,start(9,5),stopp(9,5))
      do 950 an95 = start(9,5),stopp(9,5),-1
...
*     9i
     ...
     :                      low,start(9,6),stopp(9,6))
      do 960 an96 = start(9,6),stopp(9,6),-1
...
*     9k
     ...
     :                      low,start(9,7),stopp(9,7))
      do 970 an97 = start(9,7),stopp(9,7),-1
...
*     9l
     ...
     :                      low,start(9,8),stopp(9,8))
      do 980 an98 = start(9,8),stopp(9,8),-1
...
*     10s
     ...
     :                      low,start(10,0),stopp(10,0))
      do 1000 anA0 = start(10,0),stopp(10,0),-1
...
*     10p
     ...
     :                      low,start(10,1),stopp(10,1))
      do 1010 anA1 = start(10,1),stopp(10,1),-1
...
*     10d
     ...
     :                      low,start(10,2),stopp(10,2))
      do 1020 anA2 = start(10,2),stopp(10,2),-1
...
*     10f
     ...
     :                      low,start(10,3),stopp(10,3))
      do 1030 anA3 = start(10,3),stopp(10,3),-1
...
*     10g
     ...
     :                      low,start(10,4),stopp(10,4))
      do 1040 anA4 = start(10,4),stopp(10,4),-1
         antel(10,4) = anA4 + antel(10,3)
         if (antel(10,4).LE.antal) then 
            do 1041plusA4 = min(anA4,10),max(anA4-8,0),-1
               ansats(10,4,1) = plusA4
               ansats(10,4,0) = anA4-plusA4
*     10h
      call Sluggo(10,5,varmax,varupp,varned,ansats,org,lock(10,5),
     :                      low,start(10,5),stopp(10,5))
      do 1050 anA5 = start(10,5),stopp(10,5),-1
...
*     10i
     ...
     :                      low,start(10,6),stopp(10,6))
      do 1060 anA6 = start(10,6),stopp(10,6),-1
...
*     10k
     ...
     :                      low,start(10,7),stopp(10,7))
      do 1070 anA7 = start(10,7),stopp(10,7),-1
...
*     10l
     ...
     :                      low,start(10,8),stopp(10,8))
      do 1080 anA8 = start(10,8),stopp(10,8),-1
...
*     10m
     ...
     :                      low,start(10,9),stopp(10,9))
      do 1090 anA9 = start(10,9),stopp(10,9),-1
...
*     11s
     ...
     :                      low,start(11,0),stopp(11,0))
      do 1100 anB0 = start(11,0),stopp(11,0),-1
...
*     11p
     ...
     :                      low,start(11,1),stopp(11,1))
      do 1110 anB1 = start(11,1),stopp(11,1),-1
...
*     11d
     ...
     :                      low,start(11,2),stopp(11,2))
      do 1120 anB2 = start(11,2),stopp(11,2),-1
...
*     11f
     ...
     :                      low,start(11,3),stopp(11,3))
      do 1130 anB3 = start(11,3),stopp(11,3),-1
...
*     11g
     ...
     :                      low,start(11,4),stopp(11,4))
      do 1140 anB4 = start(11,4),stopp(11,4),-1
...
*     11h
     ...
     :                      low,start(11,5),stopp(11,5))
      do 1150 anB5 = start(11,5),stopp(11,5),-1
...
*     11i
     ...
     :                      low,start(11,6),stopp(11,6))
      do 1160 anB6 = start(11,6),stopp(11,6),-1
...
*     11k
     ...
     :                      low,start(11,7),stopp(11,7))
      do 1170 anB7 = start(11,7),stopp(11,7),-1
...
*     11l
     ...
     :                      low,start(11,8),stopp(11,8))
      do 1180 anB8 = start(11,8),stopp(11,8),-1
...
*     11m
     ...
     :                      low,start(11,9),stopp(11,9))
      do 1190 anB9 = start(11,9),stopp(11,9),-1
...
*     11n
     ...
     :                      low,start(11,10),stopp(11,10))
      do 11100 anBA = start(11,10),stopp(11,10),-1
...
*     12s
     ...
     :                      low,start(12,0),stopp(12,0))
      do 1200 anC0 = start(12,0),stopp(12,0),-1
...
*     12p
     ...
     :                      low,start(12,1),stopp(12,1))
      do 1210 anC1 = start(12,1),stopp(12,1),-1
...
*     12d
     ...
     :                      low,start(12,2),stopp(12,2))
      do 1220 anC2 = start(12,2),stopp(12,2),-1
...
*     12f
     ...
     :                      low,start(12,3),stopp(12,3))
      do 1230 anC3 = start(12,3),stopp(12,3),-1
...
*     12g
     ...
     :                      low,start(12,4),stopp(12,4))
      do 1240 anC4 = start(12,4),stopp(12,4),-1
...
*     12h
     ...
     :                      low,start(12,5),stopp(12,5))
      do 1250 anC5 = start(12,5),stopp(12,5),-1
...
*     12i
     ...
     :                      low,start(12,6),stopp(12,6))
      do 1260 anC6 = start(12,6),stopp(12,6),-1
...
*     12k
     ...
     :                      low,start(12,7),stopp(12,7))
      do 1270 anC7 = start(12,7),stopp(12,7),-1
...
*     12l
     ...
     :                      low,start(12,8),stopp(12,8))
      do 1280 anC8 = start(12,8),stopp(12,8),-1
...
*     12m
     ...
     :                      low,start(12,9),stopp(12,9))
      do 1290 anC9 = start(12,9),stopp(12,9),-1
...
*     12n
     ...
     :                      low,start(12,10),stopp(12,10))
      do 12100 anCA = start(12,10),stopp(12,10),-1
...
*     13s
     ...
     :                      low,start(13,0),stopp(13,0))
      do 1300 anD0 = start(13,0),stopp(13,0),-1
...
*     13p
     ...
     :                      low,start(13,1),stopp(13,1))
      do 1310 anD1 = start(13,1),stopp(13,1),-1
...
*     13d
     ...
     :                      low,start(13,2),stopp(13,2))
      do 1320 anD2 = start(13,2),stopp(13,2),-1
...
*     13f
     ...
     :                      low,start(13,3),stopp(13,3))
      do 1330 anD3 = start(13,3),stopp(13,3),-1
...
*     13g
     ...
     :                      low,start(13,4),stopp(13,4))
      do 1340 anD4 = start(13,4),stopp(13,4),-1
...
*     13h
     ...
     :                      low,start(13,5),stopp(13,5))
      do 1350 anD5 = start(13,5),stopp(13,5),-1
...
*     13i
     ...
     :                      low,start(13,6),stopp(13,6))
      do 1360 anD6 = start(13,6),stopp(13,6),-1
...
*     13k
     ...
     :                      low,start(13,7),stopp(13,7))
      do 1370 anD7 = start(13,7),stopp(13,7),-1
...
*     13l
     ...
     :                      low,start(13,8),stopp(13,8))
      do 1380 anD8 = start(13,8),stopp(13,8),-1
...
*     13m
     ...
     :                      low,start(13,9),stopp(13,9))
      do 1390 anD9 = start(13,9),stopp(13,9),-1
...
*     13n
     ...
     :                      low,start(13,10),stopp(13,10))
      do 13100 anDA = start(13,10),stopp(13,10),-1
...
*     14s
     ...
     :                      low,start(14,0),stopp(14,0))
      do 1400 anE0 = start(14,0),stopp(14,0),-1
...
*     14p
     ...
     :                      low,start(14,1),stopp(14,1))
      do 1410 anE1 = start(14,1),stopp(14,1),-1
...
*     14d
     ...
     :                      low,start(14,2),stopp(14,2))
      do 1420 anE2 = start(14,2),stopp(14,2),-1
...
*     14f
     ...
     :                      low,start(14,3),stopp(14,3))
      do 1430 anE3 = start(14,3),stopp(14,3),-1
...
*     14g
     ...
     :                      low,start(14,4),stopp(14,4))
      do 1440 anE4 = start(14,4),stopp(14,4),-1
...
*     14h
     ...
     :                      low,start(14,5),stopp(14,5))
      do 1450 anE5 = start(14,5),stopp(14,5),-1
...
*     14i
     ...
     :                      low,start(14,6),stopp(14,6))
      do 1460 anE6 = start(14,6),stopp(14,6),-1
...
*     14k
     ...
     :                      low,start(14,7),stopp(14,7))
      do 1470 anE7 = start(14,7),stopp(14,7),-1
...
*     14l
     ...
     :                      low,start(14,8),stopp(14,8))
      do 1480 anE8 = start(14,8),stopp(14,8),-1
...
*     14m
     ...
     :                      low,start(14,9),stopp(14,9))
      do 1490 anE9 = start(14,9),stopp(14,9),-1
...
*     14n
     ...
     :                      low,start(14,10),stopp(14,10))
      do 14100 anEA = start(14,10),stopp(14,10),-1
...
*     15s
     ...
     :                      low,start(15,0),stopp(15,0))
      do 1500 anF0 = start(15,0),stopp(15,0),-1
...
*     15p
     ...
     :                      low,start(15,1),stopp(15,1))
      do 1510 anF1 = start(15,1),stopp(15,1),-1
...
*     15d
     ...
     :                      low,start(15,2),stopp(15,2))
      do 1520 anF2 = start(15,2),stopp(15,2),-1
...
*     15f
     ...
     :                      low,start(15,3),stopp(15,3))
      do 1530 anF3 = start(15,3),stopp(15,3),-1
...
*     15g
     ...
     :                      low,start(15,4),stopp(15,4))
      do 1540 anF4 = start(15,4),stopp(15,4),-1
...
*     15h
     ...
     :                      low,start(15,5),stopp(15,5))
      do 1550 anF5 = start(15,5),stopp(15,5),-1
...
*     15i
     ...
     :                      low,start(15,6),stopp(15,6))
      do 1560 anF6 = start(15,6),stopp(15,6),-1
...
*     15k
     ...
     :                      low,start(15,7),stopp(15,7))
      do 1570 anF7 = start(15,7),stopp(15,7),-1
...
*     15l
     ...
     :                      low,start(15,8),stopp(15,8))
      do 1580 anF8 = start(15,8),stopp(15,8),-1
...
*     15m
     ...
     :                      low,start(15,9),stopp(15,9))
      do 1590 anF9 = start(15,9),stopp(15,9),-1
...
*     15n
     ...
     :                      low,start(15,10),stopp(15,10))
      do 15100 anFA = start(15,10),stopp(15,10),-1
    ...
    6                   par = mod(par+j*(ansats(i,j,0)+ansats(i,j,1)),2)
                  if (par.EQ.par0) then
                     if (elar.NE.antal) write(*,*) 'FEL'
                     cf = cf+1
                     do 1600 i=1,15
                        write(fil,5000) (ansats(i,j,0),j=0,min(10,i-1))
 1600                   write(fil,5000) (ansats(i,j,1),j=0,min(10,i-1))
                  endif
               endif
15101 continue
      endif
