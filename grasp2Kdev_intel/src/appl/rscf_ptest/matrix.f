...
!-----------------------------------------------------------------------
! pfeast hack, local nprocss and myidd
      nprocss = 1
      myidd = 0
...
*=======================================================================
     ...
     &   STOP 'matrx: jblockt .NE. jblock .OR. ncf1 .NE. ncf2'
      ...
      READ (30) (iendc(i), i = myidd + 1, ncf, nprocss), 
     &           (irow(i), i = 1, nelmnt)
...
*=======================================================================
      ...
      CALL setham (jblock, myidd, nprocss)
*
*   Determine average energy
*
      eav = 0.D0
      DO ir = myidd + 1, ncf, nprocss
...
!      if(myid == 0) call hmout (0, 1, ncf,eav)
